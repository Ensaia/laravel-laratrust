...
Route::middleware(['auth', 'with.privileges', 'verified'])->group(function () {
     ...
     * Home Profile
     */
    Route::withoutMiddleware([CheckUserPrivileges::class])->controller(\App\Http\Controllers\HomeController::class)->group(function () {
...
*/
    ...
    ** POSTS
    */
    Route::middleware(['ability:admin|publisher|editor,create-post|edit-post|delete-post'])->controller(\App\Http\Controllers\PostController::class)->group(function () {
